...
<html>
            ...
            <div  id="mid">
                <div class="info">
                    ...
                    <?php
                        ...
                        $sql = "select * from sale where id=".$sale_id;
                        $query = mysqli_query($con,$sql);
                        $salecst = mysqli_fetch_assoc($query);

                        $userid= $_SESSION['userid'];
                        $sql="select * from customer where id='".$salecst['customer']."'";
                        $query=mysqli_query($con,$sql);
    ...
    <?php
        ...
        try {
            ...
            // $mail->Body    = 'Greetings '.$userdata['name'].', '.'Your Purchase Was Succesful. Hope You enjoyed shopping with Us. We wish to see you again.';
            $emailBody = 'Greetings ' . $userdata['name'] . ', ' .
                'Your purchase was successful. We hope you enjoyed shopping with us. ' .
